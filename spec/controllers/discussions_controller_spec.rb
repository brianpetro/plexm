  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved discussion as @discussion" do
        ...
        post :create, {:discussion => { "discussion" => "invalid value" }}, valid_session
        assigns(:discussion).should be_a_new(Discussion)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested discussion" do
        ...
        Discussion.any_instance.should_receive(:update_attributes).with({ "discussion" => "MyText" })
        put :update, {:id => discussion.to_param, :discussion => { "discussion" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the discussion as @discussion" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Discussion.any_instance.stub(:save).and_return(false)
        put :update, {:id => discussion.to_param, :discussion => { "discussion" => "invalid value" }}, valid_session
        assigns(:discussion).should eq(discussion)
      end
