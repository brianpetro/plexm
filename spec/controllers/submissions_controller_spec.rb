  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved submission as @submission" do
        ...
        post :create, {:submission => { "upload_id" => "invalid value" }}, valid_session
        assigns(:submission).should be_a_new(Submission)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested submission" do
        ...
        Submission.any_instance.should_receive(:update_attributes).with({ "upload_id" => "1" })
        put :update, {:id => submission.to_param, :submission => { "upload_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the submission as @submission" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Submission.any_instance.stub(:save).and_return(false)
        put :update, {:id => submission.to_param, :submission => { "upload_id" => "invalid value" }}, valid_session
        assigns(:submission).should eq(submission)
      end
